...
PAGES = {
    "index.html": ("portable/index.html", "portable/单文件预览_总览.html"),
...
def main() -> int:
    generated: list[Path] = []
    for source_name, target_names in PAGES.items():
        ...
        if unresolved:
            raise SystemExit(f"Portable output still references relative JavaScript: {source_name}")
