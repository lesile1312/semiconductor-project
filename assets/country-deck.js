(() => {
  ...
  integrationStyles.textContent = `
    ...
    .integrationLayer:before{content:"";position:absolute;top:0;left:7%;right:7%;height:1px;z-index:2;background:linear-gradient(90deg,transparent,rgba(62,214,197,.7),rgba(255,184,77,.52),transparent);opacity:.8}
    .integrationLayer:after{content:"";position:absolute;inset:0;z-index:0;pointer-events:none;background:radial-gradient(circle 360px at var(--gtri-x,50%) var(--gtri-y,50%),rgba(62,214,197,.18),transparent 72%);opacity:0;transition:opacity 320ms cubic-bezier(.22,1,.36,1)}.integrationLayer.gtri-hover:after{opacity:.86}.integrationLayer>*{position:relative;z-index:1}.integrationCoverage__group.gtri-hover{border-color:rgba(62,214,197,.4);box-shadow:0 0 22px rgba(62,214,197,.08),inset 0 1px 0 rgba(255,255,255,.035)}
